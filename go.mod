...
require (
	...
	github.com/runapi-ai/core-sdk/go v0.4.0
	github.com/runapi-ai/elevenlabs-sdk/go v0.2.10
	github.com/runapi-ai/fish-audio-sdk/go v0.4.0
	...
	github.com/runapi-ai/gemini-omni-sdk/go v0.3.4
	...
	github.com/runapi-ai/nano-banana-sdk/go v0.2.13
	github.com/runapi-ai/omnihuman-sdk/go v0.2.11
	github.com/runapi-ai/openai-transcription-sdk/go v0.2.0
	github.com/runapi-ai/openai-tts-sdk/go v0.2.0
	...
	github.com/runapi-ai/qwen-3-sdk/go v0.1.0
...
retract [v0.0.0, v0.12.0] // Upgrade to v0.13.0 or later to continue using RunAPI.
